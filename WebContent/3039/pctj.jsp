...
//单据号		原单据号   门店     补差金额      补差日期    审核日期    供应商编码  供应商名称  备注  
						...
						{field:'PAY_DATE',title:'补差日期',width:200,sortable:true},
						{field:'APPROVE_DATE',title:'审核日期',width:200,sortable:true},
...
//				}],
     ...
     //单据号     商品编码    商品条码   商品名称     规格     单位           包装因子      原进货价      现进货价      数量小计    差价金额
		...
		function exportExcel(){
			var searchData = getFormData( 'orderSearchHTSearchNew' ); 
			if(User.sutype == 'L'){
...
<body>
<center>
<table id="orderSearchHTSearchNew" style="line-height:20px;border:none; font-size:12px;margin:auto;width:1000px;" align="center"> 
	<tr> 
		<td colspan="6" align="left" style="border:none; color:#4574a0;">批次调价单明细</td> 
	</tr>
	<tr>
...
<!-- (2)详细区开始 -->
<table id="orderDetHTNew" width="100" style="line-height:20px;border:none;font-size: 12;display: none" align="center">
  <tr><td colspan='6' ><div style=" height: 20px"></div></td></tr>
   <tr><th colspan="6" style="align:center;font-size:24px;height: 15px">批次调价单明细</th></tr>
         <tr><td colspan='6' ><div style=" height: 20px"></div></td></tr>
