	...
	<script>
		...
		$(function(){
			$('#userManager').datagrid({
				title:'用户管理',
				width: User.sgcode=='3039'?800:650,
				singleSelect:true,
				nowrap: false,
				striped: true,
				collapsible:true,
						...
						data :obj2str(
							{		
								...
								list:[{
									sgcode : User.sgcode,
									exportExcel : true,
									//searchData['enTitle'] = ['SUCODE','SUNAME','SUTYPE','SUENABLE','ADDRESS','SALEMETHOD','FAX','LINKMAN','LINKMANTEL','SUMEMO',];
									//searchData['cnTitle'] = ['用户编码','用户名称','用户类型','启用','地址','经营方式','传真','联系人','联系人电话','备注'];							 		
									
									//	enTitle: ['SUCODE','SUNAME','SUPADD','SUPFAX','SUPCONT','SUPCONTPHONE','MEMO',],
									//	cnTitle: ['用户编码','用户名称','地址','传真','联系人','联系人电话','备注'],													
								
								//a.sucode,a.suname,b.supadd , b.supfax ,b.supcont ,b.supcontphone,memo
								
								//enTitle: ['SUCODE','SUPCONTPHONE'],
									//	cnTitle: ['用户编码','用户名称'],						
								
								
									enTitle: ['SUCODE','SUNAME','SUTYPE','SUENABLE','ADDRESS','SALEMETHOD','FAX','LINKMAN','LINKMANTEL','SUMEMO',],
									cnTitle:  ['用户编码','用户名称','用户类型','启用','地址','经营方式','传真','联系人','联系人电话','备注'],		
